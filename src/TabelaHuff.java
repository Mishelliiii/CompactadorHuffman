...
public class TabelaHuff <X extends Comparable<X>>
// X extends Comparable<X> indica que só serão aceitas, como
// parâmetros da classe TabelaHuff, classe que herdem
...

{
    ...
    // construtor de copia
    public TabelaHuff (TabelaHuff<X> modelo) throws Exception
    {
        if (modelo==null)
    ...
    public Object clone ()
    {
        TabelaHuff<X> ret=null;

        try
        {
            ret = new TabelaHuff (this);
        }
        catch (Exception erro)
